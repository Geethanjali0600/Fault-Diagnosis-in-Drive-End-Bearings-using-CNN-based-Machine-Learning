...
data_dir = "C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/1hp"
...
path = f'C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/1hp\OR021_1.mat'
...
df.to_csv('C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/1hp/1hp_all_faults.csv', index=False)
