...
df = pd.read_csv('C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/2hp/2hp_all_faults.csv')
...
# Train the CNN model
history = cnn_model.fit(X_train, y_train, batch_size=128, epochs=50, verbose=1, validation_data=(X_test, y_test), shuffle=True)
