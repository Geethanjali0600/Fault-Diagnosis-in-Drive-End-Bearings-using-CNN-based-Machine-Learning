...
data_dir = "C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/2hp"
...
path = f'C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/2hp\OR021_2.mat'
...
df.to_csv('C:/FAULT_DIAG_PROJ/CWRU_dataset/48k_drive_end/2hp/2hp_all_faults.csv', index=False)
